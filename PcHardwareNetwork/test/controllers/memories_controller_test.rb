...
class MemoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memory" do
    assert_difference('Memory.count') do
      post memories_url, params: { memory: { brand: @memory.brand, cas_latency: @memory.cas_latency, color: @memory.color, name: @memory.name, price: @memory.price, size: @memory.size, speed: @memory.speed } }
    end
  ...
  test "should update memory" do
    patch memory_url(@memory), params: { memory: { brand: @memory.brand, cas_latency: @memory.cas_latency, color: @memory.color, name: @memory.name, price: @memory.price, size: @memory.size, speed: @memory.speed } }
